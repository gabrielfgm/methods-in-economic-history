...
-   There are echoes in modern debates: some economists have argued that much Chinese GDP growth comes from politically-directed investment (real-estate construction) valued at cost, where the consumption benefits may be illusory
...
-   Pigou's famous example: if you marry your cook, what happens to GDP?
    ...
    -   After: domestic labour is unpaid and outside the production boundary — *measured* GDP falls
...
4.  If you were constructing a **hedonic price index** for nails, what unit of service would you use — analogous to Nordhaus's lumen-hours per dollar?
