...
-   PSZ draw on work by @guyton, who compare random audits to targeted enforcement operations and tax amnesty programmes to estimate true evasion
...
-   How does PSZ treat in-kind health transfers?
-   If the price of the same service falls, does anyone receive less healthcare?
-   Does a reduction in the imputed value of health transfers affect the rich and poor symmetrically?
-   Is this a "real" change in inequality or a measurement artefact?
...
-   How does each approach allocate defence spending across the income distribution?
-   How does each approach handle the increased tax burden — who bears it?
-   Would the answer differ if spending was financed by a wealth tax vs. a consumption tax?
-   Is there a "right answer" or is this inherently a normative choice?
